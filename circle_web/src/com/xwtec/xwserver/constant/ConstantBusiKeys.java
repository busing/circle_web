...
public interface ConstantBusiKeys {
	...
	public interface SessionKey {
		 ...
		 * 客户端圈子缓存key
		 */
		public static final String M_CIRCLE = "mCircle";
		
		/**
		 * 客户端购物车缓存key
		 */
		public static final String M_SHOPCART = "mShopcart";
	...
	public interface OrderKey{
		public static final int DEFAULT_SHIP_TYPE = 13001;
		
		public static final String DEFAULT_REMARK = "无";
		
		public static final int DEFAULT_PAY_TYPE = 6002;
	}
